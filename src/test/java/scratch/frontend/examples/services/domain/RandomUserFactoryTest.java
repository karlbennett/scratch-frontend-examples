package scratch.frontend.examples.services.domain;

import cucumber.scratch.frontend.examples.domain.RandomUserFactory;
...
public class RandomUserFactoryTest {
    ...
    public void Can_create_a_random_existing_user() {
        ...
        final scratch.frontend.examples.services.domain.User user = mock(scratch.frontend.examples.services.domain.User.class);

        final String username = someString();
        final String password = someString();

        // Given
        given(userRepository.save(any(scratch.frontend.examples.services.domain.User.class))).willReturn(user);
